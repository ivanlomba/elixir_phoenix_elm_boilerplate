defmodule ElixirPhoenixElmBoilerplate.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ElixirPhoenixElmBoilerplate.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ElixirPhoenixElmBoilerplate.ErrorHelpers.translate_error/1)
